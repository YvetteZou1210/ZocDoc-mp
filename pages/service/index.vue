<template>
	<view>
		...
		<view class="od-banner">
			<!-- 背景图片 -->
			<image src="/static/images//od_bg_icon.png" mode="widthFix" class="od-banner-icon"></image>
				...
				<view class="pub-box-bd">
					...
					<view class="weui-cell weui-cell_input">
						...
						<view class="weui-cell__ft weui-cell__ft_in-access">
							<view>
								<!-- picker从底部弹起的滚动选择器。 -->
								<picker @change="onHospitalchange" :value="hopspital_index" :range="hospitals" range-key="name">
		...
		<uni-popup ref="qrcodePopup" type="center" :is-mask-click="false" background-color="#fff">
			<view class="pay-box">
				<!-- 关闭按钮 -->
				<image @click="payment" src="/static/images/modal_closer.png" style="display: block; width: 15px; height: 15px"></image>
				<!-- 提示 -->
